      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-20">
            ...
            <div className="lg:w-1/3 space-y-8">
              <div className="inline-flex items-center gap-2 border border-white/10 bg-white/5 px-3 py-1 rounded-full text-xs font-medium text-blue-300">
                <Compass size={12} />
                <span>Legislative Tracking</span>
              </div>
              <h2 className="text-5xl md:text-6xl font-serif leading-tight">
                Research that <br/> 
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300">mitigates risk.</span>
              </h2>
              ...
              <div className="pt-4">
                  ...
                  <div className="flex gap-4">
                      <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/10 transition-colors cursor-pointer border border-white/10" title="EUR-Lex">
                          <span className="font-serif font-bold">EU</span>
                      </div>
                      <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/10 transition-colors cursor-pointer border border-white/10" title="CFR (US)">
                          <span className="font-serif font-bold">US</span>
                      </div>
                       <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-white/10 transition-colors cursor-pointer border border-white/10" title="ISO Standards">
                          <span className="font-serif font-bold">ISO</span>
                      </div>
                  </div>
              </div>
            </div>
                        ...
                        <div className="bg-[#151518] rounded-2xl p-6 md:p-8 min-h-[500px] text-gray-200 font-sans relative overflow-hidden">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="col-span-2 md:col-span-1 space-y-4">
                                    <div className="bg-[#1A1A1E] p-4 rounded-xl border border-white/5 hover:border-blue-500/30 transition-colors group cursor-pointer">
                                ...
                                <div className="hidden md:block bg-[#1A1A1E] p-4 rounded-xl border border-white/5 h-full relative overflow-hidden">
